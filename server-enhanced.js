...
app.post('/api/properties', (req, res) => {
  ...
  // Set default status as 'available' for demo purposes
  const newProperty = {
    id: nextId++,
...
// GET /api/properties - Fetch all properties with optional filtering and pagination
...
app.put('/api/properties/:id', (req, res) => {
  ...
  const updatedData = { 
    ...
    updatedAt: new Date().toISOString() // Ensure updatedAt is always updated
  };
